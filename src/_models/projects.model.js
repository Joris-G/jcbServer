const projets = [
  {
    ...
    nom: "Projet A",
    description:
      "Développement d'un nouvel avion de ligne à propulsion hybride.",
    type: "Build to Print",
  ...
  },
  {
    ...
    nom: "Projet B",
    description:
      "Conception et fabrication de composants composites pour un satellite en orbite géostationnaire.",
    type: "Build-to-Spec",
  ...
  },
  {
    ...
    nom: "Projet C",
    description:
      "Amélioration des processus de fabrication pour réduire les temps de cycle des pièces aéronautiques.",
    type: "Build to Print",
